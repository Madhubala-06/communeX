    ...
    <section className="py-12 bg-gradient-to-b from-teal-50/50 to-white relative">
      ...
      <div className="max-w-6xl mx-auto px-4 relative">
        <div className="text-center mb-10">
          <h2 className=" text-xl md:text-4xl font-bold text-gray-900 mb-5">
            Popular Categories
          </h2>
          <p className="text-teal-600 text-base md:text-lg">Discover what other students are buying and selling</p>
        </div>
